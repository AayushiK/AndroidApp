            ...
            while (xrp.getEventType() != XmlResourceParser.END_DOCUMENT) {  
                if (xrp.getEventType() == XmlResourceParser.START_TAG)  {  
                    ...
                    if (s.equals("position")){  
                    	float x,y,z;
                    	try{
                    		x = xrp.getAttributeFloatValue(null, "x", 0);
                    	}catch(Exception e){
                    		x = (float) xrp.getAttributeIntValue(null, "x", 0);
                    	}
                    	try{
                    		y = xrp.getAttributeFloatValue(null, "y", 0);
                    	}catch(Exception e){
                    		y = (float)xrp.getAttributeIntValue(null, "y", 0);
                    	}
                    	try{
                    		z = xrp.getAttributeFloatValue(null, "z", 0);
                    	}catch(Exception e){
                    		z = (float)xrp.getAttributeIntValue(null, "z", 0);
                    	}
                        if (coords != null)  {  
